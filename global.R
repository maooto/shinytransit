...
testcorrs <- c('OR002') #c('NWR002', 'NWR004', 'NWR012', 'NWR014', 'NWR016', 'NWR018', 'NWR024')

restest <- res_original[res_original$period == 'morning' & 
                        res_original$corrcode %in% testcorrs
                          , ]
# 
# # # # ####### READ SHAPE DATA #############
# 
